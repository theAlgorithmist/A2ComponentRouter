...
/**
 * StoogeEpisodes - This service retrieves information on a subset of episodes starring the stooges and returns it as an Object
 *
...
@Injectable()
export class StoogeEpisodesService extends SimpleService
{
  // data is hardcoded in this version of the demo; it will come from an external source in the next version of this demo
  constructor() 
  {
    super();
